...
print(f"The average of the loans are: {average_loan_price}")
...
# Print each variable.
# YOUR CODE HERE!
x = dictionary.get("future_value")
y = dictionary.get("remaining_months")
print(x, y)
